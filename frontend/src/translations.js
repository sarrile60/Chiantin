...
const translations = {
  en: {
    ...
    cryptoDesc: 'Pay with USDC. Instant confirmation upon network verification.',
    noProcessingFees: 'No processing fees applied',
    bitcoinPayment: 'USDC Payment',
    sendExactly: 'Send exactly',
    equivalentInBtc: 'equivalent in USDC',
    useCurrentExchangeRate: 'Use current EUR/USDC exchange rate at time of transfer',
    toWalletAddress: 'To this wallet address',
    copyAddress: 'Copy Address',
    transactionHashOptional: 'Transaction Hash (Optional)',
    enterTxHash: 'Enter your USDC transaction hash for faster verification',
    ...
    ensureExactAmount: 'Ensure you send the exact EUR equivalent in USDC',
    ...
    confirmationDesc: 'Transaction reference has been recorded',
    confirmationNote: 'Our team will verify your payment within 24-48 business hours. You will receive an email notification once your account restriction has been lifted. If you have any questions, please contact our support team.',
    days: 'Days',
    hours: 'Hours',
    minutes: 'Min',
    seconds: 'Sec',
    ...
    copyAddress: 'Copy Address',
    transactionHashOptional: 'Transaction Hash (Optional)',
    enterTransactionHash: 'Enter your USDC transaction hash for faster verification',
  ...
  it: {
    ...
    cryptoDesc: 'Paga con USDC. Conferma istantanea dopo la verifica della rete.',
    noProcessingFees: 'Nessuna commissione di elaborazione',
    bitcoinPayment: 'Pagamento USDC',
    sendExactly: 'Invia esattamente',
    equivalentInBtc: 'equivalente in USDC',
    useCurrentExchangeRate: 'Usa il tasso di cambio EUR/USDC corrente al momento del trasferimento',
    toWalletAddress: 'A questo indirizzo wallet',
    copyAddress: 'Copia Indirizzo',
    transactionHashOptional: 'Hash Transazione (Opzionale)',
    enterTxHash: 'Inserisci l\'hash della transazione USDC per una verifica più rapida',
    ...
    ensureExactAmount: 'Assicurati di inviare l\'esatto equivalente EUR in USDC',
    ...
    confirmationReceived: 'La conferma è stata ricevuta',
    confirmationDesc: 'Il riferimento della transazione è stato registrato',
    confirmationNote: 'Il nostro team verificherà il pagamento entro 24-48 ore lavorative. Riceverà una notifica via email quando la restrizione sul Suo conto sarà stata rimossa. Per qualsiasi domanda, contatti il nostro servizio clienti.',
    days: 'Giorni',
    hours: 'Ore',
    minutes: 'Min',
    seconds: 'Sec',
    ...
    copyAddress: 'Copia Indirizzo',
    transactionHashOptional: 'Hash Transazione (Opzionale)',
    enterTransactionHash: 'Inserisci l\'hash della transazione USDC per una verifica più rapida',
    ...
    ensureExactAmount: 'Assicurati di inviare l\'equivalente esatto in EUR in USDC',
